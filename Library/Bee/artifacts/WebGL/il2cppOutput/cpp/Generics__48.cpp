...
IL_002b:
	{
		...
		AllocSize_t906784497648EDC3F45F4EA656C6858238BA2F7C L_6 = L_5->____current;
		V_1 = L_6;
		Func_2_t34C9E0D398C4623CB9C928A92CB82BE775927F61* L_7 = __this->___predicate;
		if (!L_7)
		{
	...
	}
	{
		...
		AllocSize_t906784497648EDC3F45F4EA656C6858238BA2F7C L_9 = V_1;
		bool L_10;
		L_10 = Func_2_Invoke_mDCFCFE818215110743C99147DFF92E7D0242F5AD_inline(L_8, L_9, il2cpp_rgctx_method(method->klass->rgctx_data, 11));
		if (!L_10)
		{
			goto IL_0061;
		}
...
IL_004d:
	{
		...
		AllocSize_t906784497648EDC3F45F4EA656C6858238BA2F7C L_12 = V_1;
		int32_t L_13;
		L_13 = Func_2_Invoke_mA862E5A889D66E48FC256E77B0F076E6FE827225_inline(L_11, L_12, il2cpp_rgctx_method(method->klass->rgctx_data, 12));
		((Iterator_1_tCCB165DB1184FCEC531345224E55B98DDF04BD07*)__this)->___current = L_13;
		return (bool)1;
	}
...
IL_0061:
	{
		...
		bool L_15;
		L_15 = Enumerator_MoveNext_m3BC7F539F68A3A80FE07A7B2707D0B7A5B8BC3AB(L_14, il2cpp_rgctx_method(method->klass->rgctx_data, 14));
		if (L_15)
		{
			goto IL_002b;
		}
